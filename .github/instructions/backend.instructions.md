...
Must match Backend Freeze + OpenAPI exactly.
...
- Timetable : POST /api/timetable must reject startTime/endTime in body; GET derives label/startTime/endTime via JOIN with schoolperiods. [file:1][file:3]
